...
class LoginController extends GetxController {
  ...
  CheckClockInController objCheckClockInController = Get.put(
    ...
    try {
      ...
      await Future.wait([
        ...
        preferences.setString(
          'company_id',
          loginModel.user.companyId.toString(),
        ),
        preferences.setString(
          'employee_id',
          loginModel.user.employeeId.toString(),
        ),
        ...
        preferences.setString(
          'permissions',
          jsonEncode(loginModel.user.permissions),
        ),
      ]);
      ...
      switch (loginModel.user.roleCode) {
        case "HR_MANAGER":
          ...
          break;
        case "COMPANY_ADMIN":
          Get.offAll(() => AdminBottomNavBar(checkpagestatuss: "login"));
          break;
        case "EMPLOYEE":
