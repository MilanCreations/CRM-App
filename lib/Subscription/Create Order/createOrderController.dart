...
class Createordercontroller extends GetxController {
  ...
  void onInit() {
    ...
    employeeCountController.addListener(() {
      ...
      print('[CreateOrderController] Employee count updated to: ${employeeCount.value}');
    });
    super.onInit();
  }
  ...
  Future<void> createOrderFunction() async {
    ...
    try {
      ...
      print('[CreateOrderController] Retrieved token: ${token != null ? "exists" : "null"}');
      ...
      print('[CreateOrderController] Calculated total amount: $totalAmount paise (₹${totalAmount/100})');

      print('[CreateOrderController] Making API request to: ${ApiConstants.createOrder}');
      ...
      print('[CreateOrderController] API response status: ${response.statusCode}');
      ...
      if (response.statusCode == 200) {
        ...
        print('[CreateOrderController] Failed to create order: ${response.statusCode}');
  ...
  Future<String?> _getToken() async {
    ...
    print('[CreateOrderController] Token retrieved: ${token != null ? "exists" : "null"}');
    return token;
  }
