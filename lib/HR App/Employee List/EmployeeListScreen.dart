...
class _EmployeeListScreenState extends State<EmployeeListScreen> {
            ...
            return Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    _infoRow("Employee ID", employee.id?.toString() ?? "-"),
                    ...
                    _infoRow("Salary", employee.salary ?? "Not Available"),
  ...
  Get.defaultDialog(
    title: "Change Status",
    middleText: "Do you want to change the status to ${newStatus.toUpperCase()}?",
    textCancel: "Cancel",
    textConfirm: "Yes",
...
void _changeEmployeeStatus(int employeeId) async {
  final ChangeEmployeeStatusController controller = Get.put(ChangeEmployeeStatusController());
  await controller.changeEmployeeFunction(employeeId); // Update this method to accept ID
