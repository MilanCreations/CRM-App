    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: Obx(() {
              if (hrLeadcontroller.isLoading.value &&
                  hrLeadcontroller.hrLeadList.isEmpty) {
              ...
              return RefreshIndicator(
                ...
                child: ListView.builder(
                  ...
                  itemCount:
                      hrLeadcontroller.hrLeadList.length +
